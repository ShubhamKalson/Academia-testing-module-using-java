...
public class Question_9 extends JFrame implements ActionListener
{
   ...
   String test_name;
	...
	Question_9(String name,int m[],String f_name)
	{
	  this.f_name=f_name;
	  marks=m.clone();
	  test_name=name;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(rb1.isSelected())
		{
			...
			new Question_10(test_name,marks,f_name);
		...
		System.out.println(marks[i]);
			...
			{
			new Question_8(test_name,marks,f_name);
			frame.setVisible(false);
		}
	}
