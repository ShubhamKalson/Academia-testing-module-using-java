...
public class Question_6 extends JFrame implements ActionListener
{
   ...
   String test_name;
	...
	Question_6(String name,int m[],String f_name)
	{
	  this.f_name=f_name;
	  marks=m.clone();
	  test_name=name;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(rb1.isSelected())
		{
			...
			new Question_7(test_name,marks,f_name);
		...
		System.out.println(marks[i]);
			...
			{
			new Question_5(test_name,marks,f_name);
			frame.setVisible(false);
		}
	}
